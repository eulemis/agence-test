        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-dark">
                    ...
                    <span class="caption-subject bold uppercase">Agence</span>
                    <span class="caption-helper">Estamos en Desarrollo</span>
                </div>

                <div class="actions">
                  
                    <button class="btn green btn-outline btn-circle modal-toggle" data-target="#mCRUD" data-toggle="modal" id="btnAgregar"><i class="fa fa-plus"></i> Nueva </button>
